# # Expose all module outputs needed for packet capture
# output "windows_server_ip" {
#   value = module.on_premise.windows_server_ip
# }

# output "windows_11_ip" {
#   value = module.on_premise.windows_11_ip
# }

# output "elk_ip" {
#   value = module.on_premise.elk_ip
# }

# output "portspoof_ip" {
#   value = module.on_premise.portspoof_ip
# }

# output "resource_group_name" {
#   value = module.on_premise.resource_group_name
# }
...
#   value = module.on_premise.network_watcher_name
# }

# output "windows_server_id" {
#   value = module.on_premise.windows_server_id
# }

# output "windows_11_id" {
#   value = module.on_premise.windows_11_id
# }

# output "storage_account_id" {
#   value = module.on_premise.storage_account_id
# }

# output "storage_account_name" {
#   value = module.on_premise.storage_account_name
# }

# output "network_watcher_id" {
#   value = module.on_premise.network_watcher_id
# }

# output "win_server_id" {
#   value = module.on_premise.win_server_id
# }

# output "win11_id" {
#   value = module.on_premise.win11_id
# }

# resource "local_file" "ansible_inventory" {
#   filename = "${path.module}/inventory.ini"
#   content = templatefile("${path.module}/inventory.tftpl", {
#     win_server_ip   = module.on_premise.windows_server_ip
#     win11_ip        = module.on_premise.windows_11_ip
#     elk_ip          = module.on_premise.elk_ip
#     portspoof_ip    = module.on_premise.portspoof_ip
